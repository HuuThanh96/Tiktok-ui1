...
const menuItem = [
    {
        ...
        subMenu: {
            tittle: 'Language',
            data: [
                { type: 'en', tittle: 'English' },
                { type: 'vi', tittle: 'VietNam' },
            ],
        },
    },
    { icon: <FeedbackIcon />, tittle: 'Feedback and help', to: '/feedback' },
    { icon: <KeyboardIcon />, tittle: 'Keyboard shortcuts', href: 'google.com' },
];

const currentMenuItem = [
    { icon: <ProfileIcon />, tittle: 'View Profile', to: '/feedback' },
    { icon: <CoinIcon />, tittle: 'Get Coin', to: '/feedback' },
    { icon: <SettingIcon />, tittle: 'Settings', to: '/feedback' },
    ...menuItem,
    { icon: <LogoutIcon />, tittle: 'Log out', to: '/feedback', separate: true },
];
...
const logInItem = [
    ...
    {
        icon: <ProfileIcon />,
        tittle: 'Use phone / email / username',
    },
    {
        icon: <FbIcon />,
        ...
        <div className={cx('wrapper')}>
            <div className={cx('inner')}>
                ...
                <div className={cx('action')}>
                    ...
                    <Menu items={currentUser ? currentMenuItem : menuItem}>
                        {currentUser ? (
                            <img
                                src="https://files.fullstack.edu.vn/f8-tiktok/users/103/6302e035113be.jpg"
                                className={cx('current-avt')}
                            />
                        ) : (
